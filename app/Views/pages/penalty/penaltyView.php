...
<div class="pd-20 card-box mb-30">
    <div class="clearfix mb-20">
        <div class="pull-left">
            <h4 class="text-blue h4">Penalty Details</h4>
        ...
        <div class="pull-right">
            ...
            <a href="<?= route_to('penality.edit', $penalty['penalityID']) ?>" class="btn btn-primary btn-sm">Edit</a>
        </div>
    </div>
    ...
    <div class="row">
        ...
        <div class="col-md-8">
            <div class="profile-info">
                <h5 class="mb-20 h5">Penalty Information</h5>
                <ul>
                    <li>
                        <span>Period:</span>
                        <?= $penalty['period'] == '1' ? 'First Half' : 'Second Half' ?>
                    </li>
                    <li>
                        <span>Time:</span>
                        <?= esc($penalty['time']) ?>
                    ...
                    <li>
                        <span>Type:</span>
                        <?= esc($penalty['penalityType']) ?>
                    </li>
                    <li>
                        <span>Status:</span>
                        <?= $penalty['isDeleted'] ? '<span class="text-danger">Deleted</span>' : '<span class="text-success">Active</span>' ?>
                    </li>
                </ul>
            </div>
        </div>
